...
public class AboutResource {
	...
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public About lookupAboutById(@PathParam("id") long id) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response createAbout(About about) {

		Response.ResponseBuilder builder = null;

		try {
			// Validates about using bean validation
			validateAbout(about);
	...
	/**
	 * <p>
	 * Validates the given About variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing about with the same email is
	 ...
	 *             If about with the same email already exists
	 */
	private void validateAbout(About about)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<About>> violations = validator
				.validate(about);

...
public class InstitutionResource {
	...
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public Institution lookupInstitutionById(@PathParam("id") long id) {
	...
	public Response createInstitution(Institution institution) {
		...
		try {
			// Validates institution using bean validation
	...
	/**
	 * <p>
	 * Validates the given Institution variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing institution with the same email is
	 * registered it throws a regular validation exception so that it can be
	 * interpreted separately.
	 * </p>
	 * 
	 * @param institution
	 *            Institution to be validated
	 * @throws ConstraintViolationException
	 *             If Bean Validation errors exist
	 * @throws ValidationException
	 *             If institution with the same email already exists
	 */
	private void validateInstitution(Institution institution)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<Institution>> violations = validator

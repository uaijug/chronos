...
public class PageResource {
	...
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public Page lookupPageById(@PathParam("id") long id) {
 ...
 */
	...
	public Response createPage(Page page) {
		...
		try {
			// Validates page using bean validation
			validatePage(page);
	...
	/**
	 * <p>
	 * Validates the given Page variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing page with the same email is
	 ...
	 *             If page with the same email already exists
	 */
	private void validatePage(Page page)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<Page>> violations = validator
				.validate(page);

...
public class PostCommentResource {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response createPost(PostComment postComment) {

		Response.ResponseBuilder builder = null;

		try {
			// Validates post using bean validation
			validatePostComment(postComment);

			registration.register(postComment);
	...
	private void validatePostComment(PostComment postComment)
		...
		Set<ConstraintViolation<PostComment>> violations = validator

 ...
 */
package br.com.uaijug.chronos.blog.resources;
...
public class PostCategoryResource {
	...
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public PostCategory lookupPostById(@PathParam("id") long id) {
		PostCategory postCategory = repository.findById(id);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response createPost(PostCategory postCategory) {

		Response.ResponseBuilder builder = null;

		try {
			// Validates post using bean validation
			validatePostCategory(postCategory);

			registration.register(postCategory);
	...
	/**
	 * <p>
	 * Validates the given Post variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing post with the same email is
	...
	private void validatePostCategory(PostCategory postCategory)
		...
		Set<ConstraintViolation<PostCategory>> violations = validator
				.validate(postCategory);

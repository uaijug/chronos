...
public class CityResource {
	...
	/**
	 * Creates a new city from the values provided. Performs validation, and
	 ...
	 * </p>
	 * <p>
	 * If the error is caused because an existing city with the same email is
	 ...
	 *             If city with the same email already exists
	 */
	private void validateCity(City city)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<City>> violations = validator
				.validate(city);

...
public class CountryResource {
	 ...
	 * </p>
	 * <p>
	 * If the error is caused because an existing country with the same email is
	 ...
	 *             If country with the same email already exists
	 */
	private void validateCountry(Country country)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<Country>> violations = validator
				.validate(country);

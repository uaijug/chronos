...
/**
 * The Class CityRegistrationImpl.
 * 
 * @author Rogerio Fontes - http://www.rogeriofontes.inf.br - rogerio.fontes at rogeriofontes dot inf dot br
 * 
 */
@Stateless
public class CityRegistrationImpl extends PersistenceBase<City, Long> implements CityRegistration {
     ...
     */
    @Override
  	public Boolean register(City city) {
  		Boolean saved = false;
  		if (exists(city.getId())) {
  			...
  			if (city.getId() != null) {
  				log.info("Updating " + city.getDescription());
  				update(city);
  			} else {
  				log.info("Registering " + city.getDescription());
  				save(city);
  			}
  		}

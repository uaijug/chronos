...
public class AddressResource {
	...
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public Address lookupAddressById(@PathParam("id") long id) {
	...
	/**
	 * Creates a new address from the values provided. Performs validation, and
	...
	public Response createAddress(Address address) {
		...
		try {
			// Validates address using bean validation
	...
	/**
	 * <p>
	 * Validates the given Address variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing address with the same email is
	 ...
	 *             If address with the same email already exists
	 */

...
public class StateResource {
	 ...
	 * </p>
	 * <p>
	 * If the error is caused because an existing state with the same email is
	 ...
	 *             If state with the same email already exists
	 */
	private void validateState(State state)
			throws ConstraintViolationException, ValidationException {
		// Create a bean validator and check for issues.
		Set<ConstraintViolation<State>> violations = validator
				.validate(state);

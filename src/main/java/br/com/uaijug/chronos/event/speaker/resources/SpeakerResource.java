 ...
 */
package br.com.uaijug.chronos.event.speaker.resources;
...
public class SpeakerResource {
	...
	public Response createSpeaker(Speaker speaker) {
		...
		try {
			// Validates speaker using bean validation
			validateSpeaker(speaker);

			registration.register(speaker);
	...
	/**
	 * <p>
	 * Validates the given Speaker variable and throws validation exceptions
	 * based on the type of error. If the error is standard bean validation
	 * errors then it will throw a ConstraintValidationException with the set of
	 * the constraints violated.
	 * </p>
	 * <p>
	 * If the error is caused because an existing speaker with the same email is
	 * registered it throws a regular validation exception so that it can be
	 * interpreted separately.
	 * </p>
	 * 
	 * @param speaker
	 *            Speaker to be validated
	 * @throws ConstraintViolationException
	 *             If Bean Validation errors exist
	 * @throws ValidationException
	 *             If speaker with the same email already exists
	 */
